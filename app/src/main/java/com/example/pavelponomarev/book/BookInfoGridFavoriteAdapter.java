...
public class BookInfoGridFavoriteAdapter extends BaseAdapter {
    private Context context;
    private ArrayList<BookInfo> bookInfoList;


    public BookInfoGridFavoriteAdapter(Context context, List<BookInfo> bookInfoList) {
        this.context = context;
        this.bookInfoList = (ArrayList<BookInfo>) bookInfoList;
